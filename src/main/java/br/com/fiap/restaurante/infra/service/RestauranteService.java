...
import br.com.fiap.restaurante.infra.dtos.EnderecoResponseDTO;
import br.com.fiap.restaurante.infra.dtos.RestauranteRequestDTO;
...
import br.com.fiap.restaurante.infra.database.repositories.jpa.EnderecoRepository;
...
public class RestauranteService {
    ...
    public RestauranteResponseDTO cadastrarRestaurante(RestauranteRequestDTO dto ) {
        ...
        UsuarioEntity usuarioEntity = usuarioRepository.findById(dto.dono())
        ...
        restaurante.setDono(usuarioEntity); // (Mudou de setUsuario para setDono - certifique-se que a entidade tem 'dono')
